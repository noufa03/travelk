    ...
    <nav id="sidebar" style="display: flex;flex-direction:column;justify-content:space-between">
        <ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <div>
                        <li><a href="/myreviews_rest" class="<?= urlIs('/myreviews_rest') ? 'active' : ''; ?>">Reviews</a></li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <div>
                        <li><a href="/tables/Add" class="<?= urlIs('/tables/Add') ? 'active' : ''; ?>">Add Table</a></li>
                        <li><a href="/tables" class="<?= urlIs('/tables') ? 'active' : ''; ?>">Table List</a></li>
                    </div>
                </ul>
            </li>
            <li>
                ...
                <ul class="sub-menu">
                    <div>
                        <li><a href="/myoffers/add" class="<?= urlIs('/myoffers/add') ? 'active' : ''; ?>"> Add Offer</a></li>
                        <li><a href="/myoffers" class="<?= urlIs('/myoffers') ? 'active' : ''; ?>">Offer List</a></li>
                    </div>
                </ul>
            </li>
            <li>
                ...
                <ul class="sub-menu">
                    <div>
                        <li>
                            ...
                            <a href="/issues/restaurant" class="<?= urlIs('/settings') ? 'active' : ''; ?>">
