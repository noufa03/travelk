...
<?php include('../Http/controllers/admin/header.php'); ?>
    ...
    <div class="content">
        ...
        <a href="/admin/notifications/areaadminnotifications" class="btn-primary">Area Admin Notifications</a>
        <a href="/admin/notifications/deleted" class="btn-primary">Deleted Notifications</a>
