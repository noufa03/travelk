...
<div class="content">
  ...
  <a href="/admin/notifications/create" class="btn-primary">Send New Notification</a>
  <a href="/admin/notifications/areaadminnotifications" class="btn-primary btn-secondary">Area Admin Notifications</a>
  <a href="/admin/notifications/deleted" class="btn-primary btn-secondary">Deleted Notifications</a>
          ...
          <tr>
            ...
            <td class="action-buttons">
              ...
              <form action="/admin/notifications/delete" method="POST" style="display:inline;">
                <input type="hidden" name="id" value="<?= htmlspecialchars((string) $notification['id']) ?>">
