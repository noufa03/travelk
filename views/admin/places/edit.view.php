...
<div class="container">
  ...
  <div class="form-container">
    <form action="/admin/places/update" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-section">
        ...
        <div class="form-row-flex">
          ...
          <div class="form-col">
            ...
            <input type="text" id="display_name" name="display_name" value="<?= htmlspecialchars($location['display_name'] ?? '') ?>">
          </div>
        </div>
        
        <div class="form-row">
          <label for="street_address">Address:</label>
          <textarea id="street_address" name="street_address" placeholder="Keep empty if there is none"><?= htmlspecialchars($location['street_address'] ?? '') ?></textarea>
        </div>
        
        <div class="form-row">
          <label for="city">Closest City:</label>
          <input type="text" id="city" name="city" value="<?= htmlspecialchars($location['city']) ?>" required>
        </div>
        ...
        <div class="form-row">
          ...
          <select name="district_id" id="district" required>
            ...
            <?php foreach ($districts as $district): ?>
              <option value="<?= $district['districtid'] ?>" <?= $location['districtid'] == $district['districtid'] ? 'selected' : '' ?>>
      ...
      <div class="form-section">
        ...
        <div class="form-row-flex">
          <div class="form-col-60">
            ...
            <input type="url" id="google_map_link" name="google_map_link" value="<?= htmlspecialchars($location['google_map_link'] ?? '') ?>">
          </div>
          ...
          <div class="form-col-40">
            ...
            <select id="categoryid" name="categoryid" required>
              ...
              <option value="1" <?= $place['categoryid'] == 1 ? 'selected' : '' ?>>Historical</option>
              <option value="2" <?= $place['categoryid'] == 2 ? 'selected' : '' ?>>Pilgrimage</option>
              <option value="3" <?= $place['categoryid'] == 3 ? 'selected' : '' ?>>Natural</option>
            </select>
          </div>
        </div>
        ...
        <div class="form-row">
          ...
          <textarea id="description" name="description"><?= htmlspecialchars($place['description'] ?? '') ?></textarea>
        </div>
      ...
      <div class="form-section">
          ...
          <div class="form-col">
            <div class="slider-container">
              ...
              <div class="slider-controls">
                ...
                $start_minutes = 540;
                $end_minutes = 960;
                if (!empty($place['best_travel_time'])) {
                  $times = explode(' - ', $place['best_travel_time']);
                  if (count($times) === 2) {
                ...
                <div class="slider-wrapper">
                  ...
                  <input type="range" id="startTimeVisit" name="startTimeVisit" min="0" max="1410" step="30"
                    value="<?= $start_minutes ?>" oninput="updateTimeDisplay('startTimeVisit', 'endTimeVisit', 'timeDisplayVisit', 'visit_h')" />
                </div>
                <div class="slider-wrapper">
                  <span class="slider-label">End Time</span>
                  <input type="range" id="endTimeVisit" name="endTimeVisit" min="0" max="1410" step="30"
                    value="<?= $end_minutes ?>" oninput="updateTimeDisplay('startTimeVisit', 'endTimeVisit', 'timeDisplayVisit', 'visit_h')" />
                </div>
                <div class="time-display" id="timeDisplayVisit">
                  <?= htmlspecialchars($place['best_travel_time'] ?? '09:00 - 16:00') ?>
                </div>
                <input type="hidden" id="visit_h" name="visit_h" value="<?= htmlspecialchars($place['best_travel_time'] ?? '09:00 - 16:00') ?>">
              </div>
            </div>
          </div>
          ...
          <div class="form-col">
            <div class="fee-container">
              ...
              <div class="fee-input-container">
                <input type="text" id="entry_fee" name="entry_fee" value="<?= htmlspecialchars($place['entry_fee'] ?? '') ?>" placeholder="0.00">
              </div>
            </div>
          </div>
        ...
        <div class="form-row">
          ...
          <textarea id="accessibility" name="accessibility"><?= htmlspecialchars($place['accessibility'] ?? '') ?></textarea>
        </div>
      </div>
      
      <div class="button-container">
        <button class="add-location-btn" type="submit">Update Location</button>
