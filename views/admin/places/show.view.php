...
<body>
    ...
    <div class="content">
        ...
        <a href="/admin/places/create" class="btn-primary" id="openPopup" style="margin-left: 20px;">Add Place</a>
                        ...
                        <tr>
                            ...
                            <td class="action-buttons">
                                ...
                                <form action="/admin/places/delete" method="POST" style="display:inline;">
                                    ...
                                    <button type="submit" class="button delete-button" style="background-color: red;">Delete</button>
                                </form>
                            </td>
                        </tr>
                    <?php endforeach; ?>
