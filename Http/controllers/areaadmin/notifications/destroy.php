...
$notification = $db->query(
    'SELECT body, created_at, adminid, recipient FROM admin_notifications WHERE id = :id',
    ['id' => $_POST['id']]
)->find();
...
if ($notification) {
    ...
    $db->query(
        'INSERT INTO deleted_admin_notifications (body, created_at, deleted_at, adminid, recipient)
         VALUES (:body, :created_at, :deleted_at, :adminid, :recipient)',
        [
