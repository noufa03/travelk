...
$operatingHoursFrom = date("h A", strtotime($operatingHoursFrom));// covert the str to time
...
$Averageratings = ($storeRating + $cuisineRating) / 2;// avg ratings =storerating+cuisnratings/2
...
//res details,same id as the userid
...
//reservtaaions =tablename+reservatiobs+trvalers
...
$notifications=$expired_offers_notifications;
