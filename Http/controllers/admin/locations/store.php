...
if (!Validator::string($_POST['location_type'], 1, 50)) {
    $errors['location_type'] = 'Location type is required and must be no more than 50 characters.';
}
...
$db->query(
    'INSERT INTO "places" (placeid, description, key_words, categoryid, open_h, entry_fee_type, entry_fee, best_travel_time, accessibility, website)
    VALUES (:placeid, :description, :key_words, :categoryid, :open_h, :entry_fee_type, :entry_fee, :best_travel_time, :accessibility, :website)',
    [
